...
import com.ferran.app.domain.Team;
import com.ferran.app.repository.TeamRepository;
import com.ferran.app.service.TeamService;
...
public class TeamResourceIntTest {
    ...
    private static final LocalDate DEFAULT_FUNDATION_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_FUNDATION_DATE = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Team createEntity(EntityManager em) {
        Team team = new Team()
                .name(DEFAULT_NAME)
                .fundationDate(DEFAULT_FUNDATION_DATE);
        return team;
    }
    ...
    public void createTeam() throws Exception {
        ...
        assertThat(testTeam.getFundationDate()).isEqualTo(DEFAULT_FUNDATION_DATE);
    }
    ...
    public void getAllTeams() throws Exception {
        ...
        restTeamMockMvc.perform(get("/api/teams?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].fundationDate").value(hasItem(DEFAULT_FUNDATION_DATE.toString())));
    }
    ...
    public void getTeam() throws Exception {
        ...
        restTeamMockMvc.perform(get("/api/teams/{id}", team.getId()))
            ...
            .andExpect(jsonPath("$.fundationDate").value(DEFAULT_FUNDATION_DATE.toString()));
    }
    ...
    public void updateTeam() throws Exception {
        ...
        updatedTeam
                .name(UPDATED_NAME)
                .fundationDate(UPDATED_FUNDATION_DATE);
        ...
        assertThat(testTeam.getFundationDate()).isEqualTo(UPDATED_FUNDATION_DATE);
    }
