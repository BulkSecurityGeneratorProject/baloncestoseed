...
import com.ferran.app.repository.PlayerRepository;
import com.ferran.app.service.PlayerService;
...
public class PlayerResourceIntTest {
    ...
    @Test
    @Transactional
    public void checkNbasketsIsRequired() throws Exception {
        int databaseSizeBeforeTest = playerRepository.findAll().size();
        // set the field null
        player.setNbaskets(null);
    ...
    @Test
    @Transactional
    public void checkNassistsIsRequired() throws Exception {
        int databaseSizeBeforeTest = playerRepository.findAll().size();
        // set the field null
        player.setNassists(null);
